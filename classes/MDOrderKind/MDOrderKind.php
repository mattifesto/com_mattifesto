...
final class MDOrderKind {
    ...
    static function CBInstall_configure(): void {
        CBModelUpdater::update(
            (object)[
                ...
                'defaultOrderKindClassName' => __CLASS__,
            ]
        );
    }
    /* CBInstall_configure() */
     ...
     * @return string
     */
    static function SCOrderKind_countryCodeToCountryName(
        string $countryCode
    ): string {
        $matches = array_filter(
            MDOrderKind::SCOrderKind_countryOptions(),
     ...
     * @return [object]
     */
    static function SCOrderKind_countryOptions() {
        return [
            (object)[
                'isDefault' => true,
                'title' => 'United States',
     ...
     * @return string
     */
    static function SCOrderKind_countryOptionValueToCountryCode(
